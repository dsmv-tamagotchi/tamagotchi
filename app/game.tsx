...
import { PETS_CONFIG } from '../constants/petConfig';
...
export default function GameScreen() {
  ...
  const finalPetName = petName;

//configuração visual de cada pet 
const petVisual = PETS_CONFIG[finalPetName];
        ...
        <SafeAreaView style={styles.container}>
          ...
          <GestureDetector gesture={petCarinhoGesture}>
            <View style={styles.avatarContainer}>
              <Image 
                source={petVisual.baseSprites[avatarBase]} 
...
const styles = StyleSheet.create({
  ...
  backButton: { position: 'absolute', top: 50, left: 20, backgroundColor: 'rgba(0, 0, 0, 0.6)', paddingVertical: 8, paddingHorizontal: 14, borderRadius: 8, zIndex: 10 },
  ...
  statusCard: { borderRadius: 16, width: '70%', gap: 5 },
  deadCard: { backgroundColor: 'rgba(0, 0, 0, 0.6)', paddingVertical: 15, paddingHorizontal: 20, borderRadius: 12, width: '70%', alignItems: 'center' },
  deadText: { color: '#ffffff', fontSize: 16, fontWeight: 'bold' },
  ...
  barContainer: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: '#ecececbd', borderRadius: 10, paddingHorizontal: 5 },
  barEmoji: { fontSize: 18, width: 24, textAlign: 'center' },
  barTrack: { flex: 1, height: 10, backgroundColor: '#ffffff', borderRadius: 7, overflow: 'hidden' },
